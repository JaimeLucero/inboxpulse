                        ...
                        child: ConstrainedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Start receiving Google Analytics reports in minutes',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            Text(
              'Join founders who get their Google Analytics metrics delivered automatically — no manual pulling of reports.',
            ...
            const SizedBox(height: 12),
            _SetupStep(step: '2', text: 'Connect your Google Analytics account'),
            const SizedBox(height: 12),
            _SetupStep(step: '3', text: 'Choose your metrics & schedule'),
            const Spacer(),
            Text('© 2026 InboxPulse', style: GoogleFonts.figtree(fontSize: 12, color: AppColors.textMuted)),
          ],
        ),
      ),
    );
